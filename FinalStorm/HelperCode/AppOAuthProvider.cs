...
namespace FinalStorm
{
    internal class AppOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var user = this.userManager.Login(usernameVal, passwordVal);
            ...
            // Setting
            claims.Add(new Claim(ClaimTypes.Name, userInfo.NickName));
            ...
            AuthenticationProperties properties = CreateProperties(userInfo.NickName);
